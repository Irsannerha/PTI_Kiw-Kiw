        ...
        <div className="flex justify-center">
          <div className="p-6 rounded-2xl bg-[#FFF7ED] border border-amber-500 dark:border-neutral-950 shadow-md w-auto">
            ...
            <div className="flex items-center flex-col mb-4">
              ...
              <p className="text-gray-900  dark:text-white font-medium text-lg mt-2">{dataUs.name}</p>
            </div>
            ...
            <div className="flex justify-end items-center mt-5">
              <label
                htmlFor="logout"
                className="bg-[#F8A849] hover:bg-[#D2691E] font-medium text-black hover:text-white inline-flex items-center px-6 py-1.5 cursor-pointer text-sm rounded-xl shadow-md" onClick={handleFromLogout}>
