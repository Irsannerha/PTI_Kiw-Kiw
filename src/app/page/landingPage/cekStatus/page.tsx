      ...
      <div className="flex justify-center">
        <div className="border-b border-neutral-950/10 pb-12 m-4 w-full text-[32px] ml-12">
          ...
          <p className="mt-1 text-sm leading-6 text-gray-600">This is monitoring employee selection status.</p>
            ...
            <div className="m-10 w-full ml-36">
             <ol className="flex items-center w-full mb-4 sm:mb-5">
                <li className="flex w-full items-center text-blue-600 dark:text-blue-500 after:content-[''] after:w-full after:h-1 after:border-b after:border-amber-500 after:border-4 after:inline-block dark:after:border-blue-800">
                    <div className="flex items-center justify-center w-10 h-10 bg-[#F8A849] rounded-full lg:h-16 lg:w-16 dark:bg-[#F8A849] shrink-0">
                ...
                <div className="flex items-center justify-center w-10 h-10 bg-[#FFD8A9] rounded-full lg:h-16 lg:w-16 hover:bg-[#F8A849] dark:bg-gray-700 shrink-0">
                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="w-[20%] bg-[#FFD8A9] shadow-md rounded-xl drop-shadow-2xl">
