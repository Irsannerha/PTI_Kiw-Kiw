            ...
            <div style={{ display: 'flex' }}>
                ...
                <div style={{ marginLeft: '280px', padding: '20px' }} className="w-[77%]">
                    ...
                    <Input
                        ...
                        type="text"
                    />
                    <div className="justify-between items-center grid grid-cols-3 md:grid-cols-3 gap-2 w-full p-2 mt-8">
                        <div className="div">
                ...
                <button
                    ...
                    className="ml-[89%] mt-[35%] absolute text-white w-[8%] bg-[#F8A849] hover:bg-[#8B6A56] focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-10 py-2.5 mb-2 dark:bg-[#8B6A56] dark:hover:bg-[#F8A849] focus:outline-none flex justify-center items-center"
                >
                    Simpan
                </button>
            </div >
