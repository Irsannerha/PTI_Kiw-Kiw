...
export default function PrekTahap2LihatData({ params }: { params: { PrekTahap2LihatData: string } }) {
    ...
    const { data: userData, isLoading, error } = useSWR(`/api/applicant/one/${params.PrekTahap2LihatData}`, async (url) => {
