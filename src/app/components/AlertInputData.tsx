...
export default function AlertInputData() {
    ...
    return (
        <>
            {isVisible && (
                <div id="toast-success" className="flex items-center w-full max-w-xs p-2 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800 gap-0.5" role="alert">
                    <div className="inline-flex items-center justify-center flex-shrink-0 w-8 h-8rounded-lg">
                    ...
                    <div className="text-sm font-normal w-full">Masukkan Data yang Diperlukan</div>
                    <button
                        type="button"
