    ...
    <div className="flex justify-center items-center h-screen bg-[#F8A849]">
      ...
      <div className="w-1/2 p-2 ">
        <div className="shadow-2xl rounded-[20px] border bg-[#FCFCFC] w-full max-w-md mx-auto">
          <h2 className="text-2xl font-montserrat text-center font-SemiBold pt-[42px]" style={{ fontSize: '32px' }}> Buat Password Baru </h2>
          <form className="px-8 pt-8 pb-8 mb-4">
            <div className="mb-4">
              <label className="rounded block text-gray-700 text-sm font-bold mb-2" htmlFor="password"></label>
              <input
