...
export default function Alert() {
    ...
    return (
        <>
            {isVisible && (
                <div id="toast-success" className=" w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
                    <div className="flex items-center">
                        ...
                        <div className="ml-3 text-sm font-normal">Apakah anda yakin untuk menghapus data ini?</div>
                        <button
                            type="button"
                    ...
                    <div className="flex justify-center items-center m-auto w-full mt-2">
                        ...
                        <a href='/page/dashboard/Kategori' className="bg-[#F30101] hover:bg-[#950000] w-[20%] py-1 text-white rounded-lg mx-1 text-center"> Ya</a>
